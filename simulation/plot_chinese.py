...
plt.bar(xbar+3*width, np.array(smallsimdrramefficiency), width=width, label="RRAM PIM with schedule in [3]")
plt.bar(xbar+4*width, np.array(smallrramefficiency), width=width, label="RRAM PIM with WRAS")
...
plt.bar(xbar+3*width, np.array(simdrramthroughput), width=width, label="RRAM PIM with schedule in [3]")
plt.bar(xbar+4*width, np.array(rramthroughput), width=width, label="RRAM PIM with WRAS")
...
plt.bar(xbar+3*width, np.array(simdrramefficiency), width=width, label="RRAM PIM with schedule in [3]")
plt.bar(xbar+4*width, np.array(rramefficiency), width=width, label="RRAM PIM with WRAS")
